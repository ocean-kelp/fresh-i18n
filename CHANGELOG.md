...
- **Renamed `i18nPlugin` to `i18n`** - Updated to idiomatic Fresh 2.x middleware naming
  - `app.use(i18nPlugin({...}))` is now `app.use(i18n({...}))`
  - Smoother, cleaner, and more natural API for Fresh applications
